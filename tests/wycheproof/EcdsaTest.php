...
class EcdsaTest extends AbstractTestCase
{
    ...
    {
        $fixtures = json_decode($this->importFile("wycheproof/testvectors/ecdsa_{$curveName}_{$hasherName}_test.json"), true);
    ...
    {
        $fixtures = json_decode($this->importFile("wycheproof/testvectors/ecdsa_test.json"), true);
